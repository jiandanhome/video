...
public class RecordProgressView extends View implements IRecordProgressView {
    ...
    private void init() {
        ...
        mBackgroundColor = Color.parseColor("#A3333333");
        mNormalColor = getResources().getColor(R.color.ugckit_white);
        mDeleteColor = Color.parseColor("#B0B0B0");
        mSpaceColor = getResources().getColor(R.color.app_ugckit_color_primary);
