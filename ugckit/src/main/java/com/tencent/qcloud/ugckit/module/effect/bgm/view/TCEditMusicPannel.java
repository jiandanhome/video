...
public class TCEditMusicPannel extends RelativeLayout implements IEditMusicPannel, SeekBar.OnSeekBarChangeListener, RangeSlider.OnRangeChangeListener, View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mSeekBarMicVolume = (SeekBar) findViewById(R.id.seekbar_record_volume);
        ...
        mTextMicVolume = (TextView) findViewById(R.id.tv_record_volume);
        mTextBgmVolume = (TextView) findViewById(R.id.tv_bgm_volume);
    ...
    public void onProgressChanged(@NonNull SeekBar seekBar, int progress, boolean fromUser) {
        if (seekBar.getId() == R.id.seekbar_record_volume) {
            mTextMicVolume.setText("录音音量 "+progress+"%");
            mMicVolume = progress;
            ...
            mTextBgmVolume.setText("背景音量 "+progress+"%");
            mBGMVolume = progress;
            if (mMusicChangeListener != null) {
