...
import com.tencent.qcloud.ugckit.custom.UGCProgressView;
...
public class VideoWorkProgressFragment extends DialogFragment {
    ...
    private UGCProgressView      mProgressLoading;
...
//        setStyle(R.style.UGCKitConfirmDialogStyle, R.style.UGCKitDialogFragmentStyle);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle
        ...
        mProgressLoading = (UGCProgressView) mViewContent.findViewById(R.id.joiner_pb_loading);
    ...
    public void setProgress(int progress) {
        ...
        mProgressLoading.setProgress(progress/100F);
    }
