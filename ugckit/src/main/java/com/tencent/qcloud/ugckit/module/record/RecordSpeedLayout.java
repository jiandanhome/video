...
public class RecordSpeedLayout extends RelativeLayout implements RadioGroup.OnCheckedChangeListener, IRecordSpeedLayout {
    ...
    private int mSlowestBg   = R.drawable.bg_ugc_record_speed_single;
    private int mSlowBg      = R.drawable.bg_ugc_record_speed_single;
    private int mNormalBg    = R.drawable.bg_ugc_record_speed_single;
    private int mFastBg      = R.drawable.bg_ugc_record_speed_single;
    private int mFastestBg   = R.drawable.bg_ugc_record_speed_single;
