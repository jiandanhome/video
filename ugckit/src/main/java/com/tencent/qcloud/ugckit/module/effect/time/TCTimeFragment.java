...
public class TCTimeFragment extends Fragment implements View.OnClickListener {
    ...
    private int coverIcon = R.drawable.ic_ugc_selected_mask;
    ...
    private void initViews(@NonNull View view) {
        ...
        Glide.with(this).load(noTimeMotionGif).centerCrop().into(mImageCancel);
        Glide.with(this).load(slowMotionGif).centerCrop().into(mImageSpeed);
        Glide.with(this).load(repeatGif).centerCrop().into(mImageRepeat);
        Glide.with(this).load(reverseGif).centerCrop().into(mImageReverse);
